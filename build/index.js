 ...
 */
async function withSessionErrors(run) {
    try {
        return await run();
    }
    catch (error) {
...
server.registerTool("write_to_terminal", {
...
server.registerTool("read_terminal_output", {
...
server.registerTool("send_control_character", {
...
server.registerTool("open_terminal_session", {
